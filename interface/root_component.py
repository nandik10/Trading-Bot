...
class Root(tk.Tk):
    ...
    def _ask_before_close(self):
        result = askquestion("Confirmation", "Do you really want tot exit the application?")
        if result =="yes":
    ...
    def _update_ui(self):
        ...
        self.after(1500, self._update_ui) #adapt it to your program
    ...
    def _save_workspace(self):
        ...
        for b_index in strat_widgets['contract']:
            ...
            balance_percentage = strat_widgets['balance_percentage'][b_index].get()
            ...
            strategies.append((strategy_type, contract, timeframe, balance_percentage, take_profit, stop_loss,
