...
class BitmexFuturesClient:
    ...
    def get_contracts(self) -> typing.Dict[str, Contract]:
        ...
        # print(contracts['XBTUSD'].__dict__)
        ...
        if "table" in data:
            ...
            if data['table'] == "trade":
                ...
                for d in data['data']:
                    ...
                    # timestamp represents the time of the trade here
    ...
    def get_trade_size(self, contract: Contract, price: float, balance_percentage: float):
        ...
        xbt_size = balance * balance_percentage / 100
