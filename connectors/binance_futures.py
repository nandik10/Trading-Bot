...
class BinanceFuturesClient:
    ...
    """
        urlencode(data).encode() - query string, representing the parameters you're sending with your request
    """
    ...
    def get_balances(self) -> typing.Dict[str, Balance]:
        ...
        # print(balances['BTCUSDT'].__dict__)
    ...
    def _on_close(self, ws, msg: str, arg):
            ...
            if data['e'] == "bookTicker":
                ...
                for key, strat in self.strategies.items():
                    if strat.contract.symbol == symbol:
                        ...
                        # print("res:" + res)
                        # res - whether the trade updates the current candle or creates a new one
    ...
    def get_trade_size(self, contract: Contract, price: float, balance_percentage: float):
        ...
        trade_size = (balance * balance_percentage / 100) / price
