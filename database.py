...
class WorkspaceData:
    def __init__(self):
        ...
        self.conn.row_factory = sqlite3.Row #when u get data from sql lite db, u want to retrieve a list of sqlite row objects (like python dict)
        ...
        self.cursor.execute("CREATE TABLE IF NOT EXISTS strategies (strategy_type TEXT, contract TEXT,"
                            "timeframe TEXT, balance_percentage REAL, take_profit REAL, stop_loss REAL, extra_params TEXT)")
